...
include $(CLEAR_VARS)
LOCAL_MODULE := init.supersu.rc
LOCAL_SRC_FILES := init.supersu.rc
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := EXECUTABLES
LOCAL_MODULE_PATH := $(TARGET_OUT)/etc/init
LOCAL_UNSTRIPPED_PATH :=
LOCAL_POST_INSTALL_CMD := chattr -ia $(LOCAL_MODULE_PATH)/$(LOCAL_MODULE) && chmod 0664 $(LOCAL_MODULE_PATH)/$(LOCAL_MODULE)
include $(BUILD_PREBUILT)
